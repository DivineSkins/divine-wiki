...
description: "Switch submeshes and VFX based on game state: buffs, animations playing, timed delays. The mechanism behind form changes, passive-ready tells and transformation skins."
category: "vfx-bins"
---
