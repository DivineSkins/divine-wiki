...
If what you want is an effect at a specific frame of a specific clip, use an [animation event](/docs/lol/vfx-bins/animation-vfx) instead. Persistent conditions are for states that last, not for moments.
